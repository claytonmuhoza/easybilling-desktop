...
import { sortie_stock_schema } from '@renderer/schemas'
...
export default function CreateSortieForm({
  ...
  const sendForm = (values: z.infer<typeof sortie_stock_schema>): void => {
    console.log(values)
    closeModal()
    // startTransition(() => {
          ...
          render={({ field, fieldState: { invalid, error } }) => (
            <div className="justify-cent flex w-full flex-col items-center gap-1">
              ...
              >
                ...
                <option value="SD">Sortie Désuétudes/périmées ou obsolètes</option>
